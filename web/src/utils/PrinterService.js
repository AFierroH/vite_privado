...
if (!isElectron) {
    ...
    // TU TRUCO: Firma vacía. QZ Tray te mostrará el Pop-up, le das "Allow" y listo.
...
export const PrinterService = {
    ...
    async imprimir(params) {
        ...
        // 3. MODO WEB USB (Usa Zadig WebUSB Directo, ignora QZ Tray)
        if (params.printerType === 'usb') {
            let device = params.printerVal;
            
            if (device === "NEW_WEBUSB" || !device || !device.open) {
